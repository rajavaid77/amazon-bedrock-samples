...
lcc_up1 = '\n'.join((
    ...
    '   git clone https://github.com/rajavaid77/amazon-bedrock-samples.git',
    '   mv amazon-bedrock-samples/data-automation/bda-documents-workshop/  bda-documents-workshop',
    '   rm -rf amazon-bedrock-samples',
